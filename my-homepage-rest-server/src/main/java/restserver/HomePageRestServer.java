...
public class HomePageRestServer extends ModelServerApp {
	...
	public static void main(String[] args) {
		...
		Logger logger = LoggerFactory.getLogger(HomePageRestServer.class);
	    ...
	    SpringApplication app = new SpringApplication(HomePageRestServer.class);
