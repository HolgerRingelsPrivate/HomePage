...
public final class CT_AppSys_AppXceptionRelevance {

	/** CODETABLE: AppSys_AppXceptionRelevance **/
	public static final String CODETABLE = "AppSys_AppXceptionRelevance";
