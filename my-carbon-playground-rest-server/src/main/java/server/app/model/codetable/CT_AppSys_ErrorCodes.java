...
public final class CT_AppSys_ErrorCodes {

	/** CODETABLE: AppSys_ErrorCodes **/
	public static final String CODETABLE = "AppSys_ErrorCodes";
...
//
	...
	/**
	 * Code '00012' = Value 'Data Model not retrievible'
	 */
	public static final String DATA_MODEL_NOT_RETRIEVABLE = "00012";
...
//
	...
	public static final String textForCode(String code) {
		...
		if (code.equals("00012")) { return "Data Model not retrievible";}
		return "";
	}
	...
	public static final boolean isKnownCode(String code) {
		...
		if (code.equals("00012")) { return true; }
		return false;
	}
	...
	public static final String deliverListOfCodes(String delimiter) {
		...
		sResult = sResult + "00012" + delimiter;
