...
public class CarbonPlaygroundRestServer extends ModelServerApp {
	...
	public static void main(String[] args) {
		...
		Logger logger = LoggerFactory.getLogger(CarbonPlaygroundRestServer.class);

		
		try {
			handleDatabaseSchemaOnStartup(ArchitecturalConstants.LOGICAL_NAME);
		} catch (Exception e) {
			logger.error(null, e);
			return;
		}
		
	    SpringApplication app = new SpringApplication(CarbonPlaygroundRestServer.class);
